...
public class SharedRidePricing implements PricingStretegy {
    ...
    public double calculateFare(double distance, double demand, int numberOfPassengers) {
        double totalFare = BASE_FARE + (distance * PER_KM_RATE);
        double farePerPerson = totalFare / numberOfPassengers;
        System.out.println("Shared Ride Pricing: Base fare = " + BASE_FARE + ", Distance = " + distance + " km, Passengers = " + numberOfPassengers + ", Fare per person = " + farePerPerson);
